...
def main():
    ...
    defaults = [
        ...
        ('keepMedia = preferences.getInt("keep_media", CacheByChatsController.KEEP_MEDIA_ONE_MONTH);',
         'keepMedia = preferences.getInt("keep_media", CacheByChatsController.KEEP_MEDIA_ONE_WEEK);',
         'кэш медиа хранится неделю вместо месяца'),
    ...
    # =========================================================================
    theme_colors = [
        ('key_chats_unreadCounter', '0xFFFF3B30', 'счётчик непрочитанного — iOS-красный'),
        ...
        ('key_chat_inBubble', '0xFF262628', 'входящие сообщения — iOS-поверхность'),
        ('key_chat_outBubble', '0xFF0A84FF', 'исходящие сообщения — iOS-синий'),
        ...
        ('key_chat_inBubbleSelected', '0xFF2C2C2E', 'выделение входящего — iOS'),
        ('key_chat_outBubbleSelected', '0xFF0A84FF', 'выделение исходящего — iOS-синий'),
        ...
        ('key_chat_attachIcon', '0xFF0A84FF', 'иконка вложения — iOS-синий'),
        ('key_chat_messagePanelIcons', '0xFF0A84FF', 'иконки поля ввода — iOS-синий'),
        ...
        ('key_chat_recordedVoiceBackground', '0xFF0A84FF', 'фон записи голосового — iOS-синий'),
        ('key_chat_fieldOverlayText', '0xFF8E8E93', 'подсказка в поле ввода — iOS-серый'),
        ('key_actionBarDefaultIcon', '0xFF0A84FF', 'иконки в шапке — iOS-синий'),
        ('key_chats_actionBackground', '0xFF0A84FF', 'акцент списка чатов — iOS-синий'),
