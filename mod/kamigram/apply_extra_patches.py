...
def main():
    ...
    theme_colors = [
        ...
        ('key_chats_name', '0xFF000000', 'имя чата — чистый чёрный'),
        ('key_chats_message', '0xFF8E8E93', 'текст сообщения — iOS-серый'),
        ('key_chats_date', '0xFF8E8E93', 'дата — iOS-серый'),
        ('key_chats_nameMessage', '0xFF8E8E93', 'префикс сообщения — iOS-серый'),
        ('key_chats_pinnedIcon', '0xFF8E8E93', 'иконка закрепа — iOS-серый'),
        ('key_chats_muteIcon', '0xFF8E8E93', 'иконка беззвучного — iOS-серый'),
        ('key_chats_secretIcon', '0xFF30D158', 'иконка секретного чата — iOS-зелёный'),
        ('key_divider', '0xFF38383A', 'разделители — iOS-серые'),
        ('key_chat_serviceBackground', '0xFF262628', 'служебные сообщения — iOS-поверхность'),
        ('key_chat_selectedBackground', '0xFF1C1C1E', 'выбор чата — iOS-поверхность'),
        ('key_chat_messagePanelBackground', '0xFF1C1C1E', 'поле ввода — iOS-поверхность'),
        ('key_switchTrackChecked', '0xFF30D158', 'включённые переключатели — iOS-зелёные'),
        ('key_checkbox', '0xFF5E5CE6', 'галочки выбора — индиго'),
        ('key_fastScrollActive', '0xFF5E5CE6', 'быстрая прокрутка — индиго'),
        ('key_progressCircle', '0xFF5E5CE6', 'круговой прогресс — индиго'),
        ('key_chat_inBubble', '0xFF1C1C1E', 'входящие сообщения — графит iOS'),
        ('key_chat_outBubble', '0xFF3A3A3C', 'исходящие сообщения — светлый графит (без голубого)'),
        ('key_chat_wallpaper', '0xFF000000', 'фон чата — чистый чёрный'),
        ('key_chat_messageLinkIn', '0xFF5E5CE6', 'ссылки во входящих — индиго'),
        ('key_chat_messageLinkOut', '0xFFFFFFFF', 'ссылки в исходящих — белые'),
        ('key_chat_serviceBackgroundSelected', '0xFF2C2C2E', 'выбранное служебное — iOS'),
        ('key_chat_replyPanelName', '0xFF5E5CE6', 'имя в ответе — индиго'),
        ('key_profile_actionIcon', '0xFF5E5CE6', 'иконки действий профиля — индиго'),
        ('key_player_background', '0xFF1C1C1E', 'плеер — iOS-поверхность'),
        ('key_chat_status', '0xFF8E8E93', 'статус в чате — iOS-серый'),
        ('key_chat_topPanelBackground', '0xFF1C1C1E', 'верхняя панель чата — iOS-поверхность'),
        ('key_avatar_backgroundActionBarBlue', '0xFF5E5CE6', 'аватар в шапке — индиго'),
        ('key_chat_inBubbleSelected', '0xFF2C2C2E', 'выделение входящего — графит'),
        ('key_chat_outBubbleSelected', '0xFF48484A', 'выделение исходящего — графит'),
        ('key_chat_inLoader', '0xFF5E5CE6', 'кружок загрузки входящих — индиго'),
        ('key_chat_outLoader', '0xFF5E5CE6', 'кружок загрузки исходящих — индиго'),
        ('key_chat_attachIcon', '0xFF5E5CE6', 'иконка вложения — индиго'),
        ('key_chat_messagePanelIcons', '0xFF5E5CE6', 'иконки поля ввода — индиго'),
        ('key_chat_messagePanelSend', '0xFF5E5CE6', 'кнопка отправки — индиго'),
        ('key_chat_recordedVoiceProgress', '0xFF5E5CE6', 'прогресс голосового — индиго'),
        ('key_chat_recordedVoiceBackground', '0xFF5E5CE6', 'фон записи голосового — индиго'),
        ('key_chat_fieldOverlayText', '0xFF8E8E93', 'подсказка в поле ввода — iOS-серый'),
        ('key_actionBarDefaultIcon', '0xFF5E5CE6', 'иконки в шапке — индиго'),
        ('key_chats_actionBackground', '0xFF5E5CE6', 'акцент списка чатов — индиго'),
        ('key_windowBackgroundGray', '0xFF1C1C1E', 'фон экранов — iOS-поверхность'),
        ('key_windowBackgroundWhite', '0xFF000000', 'фон карточек — чистый чёрный'),
    ]
