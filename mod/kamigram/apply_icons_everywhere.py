...
Правила замены:
  ...
  * notification — наш ОБЫЧНЫЙ арт (круглая иконка, как лаунчер), без
    изменений, только нужные размеры (просьба пользователя от r103).
...
TARGETS = {
    "notification": "color",  # пользователь: наш обычный арт, без переделок
