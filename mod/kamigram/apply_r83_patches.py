#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Sakura r83 UI/safety cleanup applied after the r82/r83 source passes."""
...
def validate():
    ...
    try:
        ...
        if "Разработчик Sakura" not in center:
            MISS.append("Sakura settings: developer settings action missing")
        ...
        MISS.append("Sakura settings: %s" % exc)
